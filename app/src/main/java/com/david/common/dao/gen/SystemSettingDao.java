...
/** 
 * DAO for table "SYSTEM_SETTING".
*/
public class SystemSettingDao extends AbstractDao<SystemSetting, Long> {

    public static final String TABLENAME = "SYSTEM_SETTING";

    /**
     * Properties of entity SystemSetting.<br/>
    ...
    public static class Properties {
        ...
        public final static Property Volume = new Property(19, byte.class, "volume", false, "VOLUME");
        public final static Property Luminance = new Property(20, byte.class, "luminance", false, "LUMINANCE");
        public final static Property BlueTime = new Property(21, int.class, "blueTime", false, "BLUE_TIME");
    }


    public SystemSettingDao(DaoConfig config) {
        super(config);
    }
    
    public SystemSettingDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"SYSTEM_SETTING\" (" + //
                ...
                "\"LUMINANCE\" INTEGER NOT NULL ," + // 20: luminance
                "\"BLUE_TIME\" INTEGER NOT NULL );"); // 21: blueTime
    }

    /** Drops the underlying database table. */
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"SYSTEM_SETTING\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, SystemSetting entity) {
        stmt.clearBindings();
        ...
        stmt.bindLong(21, entity.getLuminance());
        stmt.bindLong(22, entity.getBlueTime());
    }

    @Override
    protected final void bindValues(SQLiteStatement stmt, SystemSetting entity) {
        stmt.clearBindings();
    ...
    @Override
    public SystemSetting readEntity(Cursor cursor, int offset) {
        SystemSetting entity = new SystemSetting( //
            ...
            (byte) cursor.getShort(offset + 19), // volume
            (byte) cursor.getShort(offset + 20), // luminance
            cursor.getInt(offset + 21) // blueTime
        );
        return entity;
    }
     
    @Override
    public void readEntity(Cursor cursor, SystemSetting entity, int offset) {
        ...
        entity.setVolume((byte) cursor.getShort(offset + 19));
        entity.setLuminance((byte) cursor.getShort(offset + 20));
        entity.setBlueTime(cursor.getInt(offset + 21));
     }
    
    @Override
    protected final Long updateKeyAfterInsert(SystemSetting entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(SystemSetting entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(SystemSetting entity) {
