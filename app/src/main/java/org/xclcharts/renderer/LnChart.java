...
public class LnChart extends AxesChart {
        ...
        for (int i = 0; i < tickCount; i++) {
            switch (pos) {
                ...
                case HORIZONTAL_CENTER:
                    ...
                    //deeplin modify
                    if (i % Constant.AXIS_X_DOT_PER_STEP == (Constant.AXIS_X_DOT_PER_STEP - 1))
    ...
    protected void renderBezierCurveLine(Canvas canvas, Paint paint,
        ...
        if (count > 3) {
            ...
            // PointF attach = lstPoints.get(lstPoints.size()-2);
...
//		Log.v(TAG, "attach.y = " + attach.y + " detach.y = " + detach.y);
